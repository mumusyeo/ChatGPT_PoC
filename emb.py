...
EMB_USE_OPENAI = '0' #os.getenv('EMB_USE_OPENAI', '0')
OPENAI_API_KEY = 'afevbNKftmbPZS4MPuL0T3BlbkFJh0gkxJqszzB4MEDqh7T8'

def _get_openai_embedding(input):
    openai.api_key = OPENAI_API_KEY#s.environ["OPENAI_API_KEY"]
